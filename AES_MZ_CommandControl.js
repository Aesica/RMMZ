...
Aesica.CommandControl.name = "AES_MZ_CommandControl";
Aesica.CommandControl.version = 2;
Aesica.Toolkit = Aesica.Toolkit || {};
Aesica.Toolkit.commandControlVersion = 1.1;
var Imported = Imported || {};
Imported[Aesica.CommandControl.name] = true;
/*:
* @target mz
* @plugindesc v2.0 Gain a greater level of control over actor battle commands.
*
* @author Aesica
*
...
* x represents a skill id and y represents the chance for that skill to activate
...
* code has access to the user and any related stats (user.hp, etc).  Multiple
...
(function($$)
{
	...
	$$.pluginParameters = PluginManager.parameters(Aesica.CommandControl.name);
	$$.params = {};
